...
public class HasilBolaView extends JFrame {

    public HasilBolaView(Bola bola) {
        initComponents(bola);
        setLocationRelativeTo(null);
        setTitle("Hasil Kalkulasi Bola");
    }

    private void initComponents(Bola bola) {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(500, 400);
        setLayout(null);

        JLabel jLabelTitle = new JLabel("HASIL HITUNG BOLA", SwingConstants.CENTER);
        ...
        JTextField jTextFieldJari = new JTextField(String.valueOf(bola.getJariJari()));
        ...
        JTextField jTextFieldVolume = new JTextField(String.format("%.2f", bola.getVolumeBola())); //
        ...
        JTextField jTextFieldLuas = new JTextField(String.format("%.2f", bola.getLuasPermukaanBola())); //
        ...
        jButtonEdit.addActionListener(e -> {
            dispose();
            new BolaView(bola).setVisible(true);
        });
